...
@FXML
    ...
    @FXML
    void cancelScreenHandler(ActionEvent event){
    ...
    void saveProductHandler(ActionEvent event) throws IOException{
       ...
       String prodMax = max.getText();
        ...
        newProduct.setProductInStock(Integer.parseInt(prodinStock));
        newProduct.setProductPrice(Double.parseDouble(prodPrice));
    ...
    public void selectedProductFill(Product product){
        ...
        includedParts = selectedProduct.getObservableAssociatedParts();
